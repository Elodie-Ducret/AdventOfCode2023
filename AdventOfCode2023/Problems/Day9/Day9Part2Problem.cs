...
public class Day9Part2Problem(string name, string path) : Problem<Oasis, int>(name, path)
{
    public static void Run()
    {
        var day1Problem = new Day9Part2Problem("Day 9 Part 1", "Day9/Day9.txt");
        var response = day1Problem.SolveProblem();
    }

    public static void RunTest1()
    {
        var day1Problem = new Day9Part2Problem("Day 9 Part 1 Test", "Day9/Day9_Part1_Test.txt");
        var response = day1Problem.SolveProblem();
    }
    ...
    {
        return input.Histories.Sum(x => x.GetBefore()); 
    }
}